...
| Local storage / offline cache | IndexedDB (future) | SQLite via Tauri (future) |
...
- The only expected long-term divergence is **offline-first** (deferred — see
  [open-questions.md](open-questions.md)). Until then, desktop == web in a window.
