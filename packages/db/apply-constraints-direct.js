...
console.log(
  'Connecting to remote Supabase to apply Unique Constraints and clean duplicates directly...',
);
...
try {
  ...
  console.log(
    '✅ Duplicates cleaned up and unique constraints applied successfully directly to remote Supabase!',
  );
} catch (error) {
