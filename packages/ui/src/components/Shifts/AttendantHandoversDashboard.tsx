...
export const AttendantHandoversDashboard: React.FC<AttendantHandoversDashboardProps> = ({
  ...
  const recordedCount = staffAssignments.filter((sa: any) =>
    handovers.some((h: any) => h.userId === sa.userId && h.duId === sa.duId),
  ).length;
  ...
  return (
    <Panel
      ...
      action={
        <Chip
          tone={assignedCount > 0 && recordedCount >= assignedCount ? 'success' : 'neutral'}
          size="sm"
        >
    ...
    >
      ...
      >
        <div ref={scrollRef} className="shift-table-scroll-container">
          <table
          ...
          >
            <thead>
              ...
              >
                ...
                <th style={{ padding: '10px 20px', fontWeight: 600, textAlign: 'center' }}>
                  Actions
                </th>
              </tr>
            </thead>
            <tbody>
              {staffAssignments && staffAssignments.length > 0 ? (
                ...
                <tr>
                  ...
                  >
                    No staff assignments found for this active shift. Assign staff dispensers in the
                    setup to record handovers.
                  </td>
                </tr>
              )}
            </tbody>
