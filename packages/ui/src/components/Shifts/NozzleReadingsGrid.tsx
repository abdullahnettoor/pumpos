            ...
            <tbody>
              {[...nozzleReadings]
                .sort((a: any, b: any) => {
                  ...
                  if (du !== 0) return du;
                  return String(a.nozzleName || '').localeCompare(
                    String(b.nozzleName || ''),
                    undefined,
                    { numeric: true },
                  );
                ...
                .map((nr: any, idx: number) => {
                  ...
                  const assignment = staffAssignments?.find((sa: any) => sa.duId === nr.duId);
                      ...
                      <td style={{ padding: '12px 20px', color: 'var(--text-default)' }}>
                        <span
                          style={{
                            ...
                            color:
                              assignedStaffName === 'Unassigned' ? 'var(--text-muted)' : '#059669',
                            fontWeight: 600,
                          }}
                        >
                          {assignedStaffName}
