...
const gstStr = (c: any) => {
  const t = c?.taxConfig;
  return t && t.gst_rate != null ? String(t.gst_rate) : '';
};
const hsnStr = (c: any) => {
  const t = c?.taxConfig;
  return t && t.hsn_code ? String(t.hsn_code) : '';
};
const hasTax = (c: any) => {
  const t = c?.taxConfig;
  return !!(t && (t.gst_rate != null || t.hsn_code));
};
...
export const IncomeCategoryManagerDrawer: React.FC<IncomeCategoryManagerDrawerProps> = ({
  isOpen,
  onClose,
  categories,
  onChanged,
        ...
        {canManage && (
          <form onSubmit={add}>
            ...
            <Input
              ...
              placeholder="e.g. Tanker rental, commission"
              maxLength={100}
            />
                ...
                {editingId === c.id ? (
                  ...
                  <>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <span
                        style={{ fontSize: '13px', color: 'var(--text-strong)', fontWeight: 500 }}
                      >
                        {c.name}
                      </span>
                      {hasTax(c) && (
