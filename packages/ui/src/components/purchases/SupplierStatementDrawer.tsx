 ...
 */
export const SupplierStatementDrawer: React.FC<SupplierStatementDrawerProps> = ({
  supplier,
  stationId,
  onClose,
  onEdit,
          ...
          >
            ...
            >
              ...
              {(supplier.metadata?.gstin ||
                supplier.metadata?.pan ||
                supplier.metadata?.billingAddress) && (
                <div
                  style={{
                ...
                >
                  ...
                  {supplier.metadata?.billingAddress && (
                    <div>
                      <strong>Billing Address:</strong> {supplier.metadata.billingAddress}
                    </div>
                  )}
                </div>
              )}
              ...
              <LedgerView
                ...
                resolve={(tx: any) => {
                  ...
                  const direction: 'debit' | 'credit' =
                    type === 'Purchase' || type === 'Adjustment' || type === 'Opening Balance'
                      ? 'debit'
                      : 'credit';
                  return {
                    id: tx.id,
                    ...
                    type,
                    typeColor:
                      type === 'Purchase' ? 'var(--brand-warning)' : 'var(--state-success-fg)',
                    notes: tx.notes,
