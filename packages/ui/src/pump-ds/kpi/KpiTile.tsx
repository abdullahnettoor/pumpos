 ...
 */
const kpiTileVariants = cva('flex min-w-0 flex-col gap-1 bg-surface px-3.5 py-3', {
  variants: {
    size: {
...
export interface KpiTileProps
  extends Omit<HTMLAttributes<HTMLDivElement>, 'children'>, VariantProps<typeof kpiTileVariants> {
